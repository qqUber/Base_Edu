...
public class AddPersonTests extends TestBase {
    ...
    public void testAddPerson() {
        ...
        app.getPersonHelper().fillAddnew(new fillAddnewEnum("Trsu", "dddaaa", "wwwqq", "nicknick", "+74959990055", "+71110099666", "createmyrules@com.tocom", "September", "2000", "i bought one mdma", "Moscow"));
